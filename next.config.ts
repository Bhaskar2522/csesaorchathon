    ...
    return [
      {
        ...
        headers: [
          // Allow Spline WebGL content (needed for mobile Chrome's stricter CSP)
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' blob: https://*.spline.design https://prod.spline.design https://my.spline.design",
              "worker-src 'self' blob: https://*.spline.design",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "font-src 'self' https://fonts.gstatic.com https://*.spline.design",
              "img-src 'self' data: blob: https://*.spline.design https://prod.spline.design",
